...
if __name__ == "__main__":
    ...
    batch_size = 10  # if gradient_accumulation_steps > 1, this is the micro-batch size 4 * 10 * 1024
    # model 根据需要更改
    max_seq_len = 1024
    dim = 1024
    n_layers = 12
    ...
    warmup_iters = 155000  # how many steps to warm up for (5% of lr_decay_iters)
    lr_decay_iters = 3100000  # should be ~= max_iters per Chinchilla
    ...
    #
    scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=max_epoch, T_mult=1, eta_min=1e-6,
                                                                     last_epoch=-1)
